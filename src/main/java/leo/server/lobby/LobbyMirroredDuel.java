...
public class LobbyMirroredDuel implements Runnable {
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public LobbyMirroredDuel(Server server) {
        this.server = server;
                ...
                while (players.size() > 1) {
                    ...
                    if (player2 != null) {
                        ...
                        if (player1.getRating() < player2.getRating()) {
                            ServerGame newGame = new ServerGame(server, player1, player2, ServerGame.DUEL, true, true, false);

                        } else if (player2.getRating() < player1.getRating()) {

                            ServerGame newGame = new ServerGame(server, player2, player1, ServerGame.DUEL, true, true, false);
