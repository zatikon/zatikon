///////////////////////////////////////////////////////////////////////
//	Name:	ScriptChanneler
//	Desc:	A channeler
//	Date:	9/25/2008 - Gabe Jones
//	TODO:
///////////////////////////////////////////////////////////////////////
...
public class ScriptChanneler implements Script {
    /////////////////////////////////////////////////////////////////
    // Constants
    /////////////////////////////////////////////////////////////////
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public ScriptChanneler(Unit newUnit, Game newGame, Castle newCastle, Castle newEnemyCastle) {
        unit = newUnit;
        game = newGame;
        castle = newCastle;
    ...
    private boolean move() {
        ...
        if (unit.getID() == Unit.GATE_GUARD) targetLocation = castle.getLocation();
    ...
    private void interpretAction(short action, short actor, short target) {
        try {
            ...
            Log.error("ScriptChanneler.interpretAction " + e);
        }
    }
}
