...
import leo.shared.crusades.UnitDoppelganger;

import java.util.Iterator;
import java.util.Vector;

public class ScriptDoppelganger implements Script {
    /////////////////////////////////////////////////////////////////
    // Constants
    /////////////////////////////////////////////////////////////////
    ...
    // Properties
    /////////////////////////////////////////////////////////////////
    private final UnitDoppelganger unit;
    private final Game game;
    private final Castle castle;
    private final Castle enemyCastle;
    private final Action attack;
    private final Action twin;


    /////////////////////////////////////////////////////////////////
    // Constructor
    /////////////////////////////////////////////////////////////////
    public ScriptDoppelganger(Unit newUnit, Game newGame, Castle newCastle, Castle newEnemyCastle) {
        unit = (UnitDoppelganger) newUnit;
        game = newGame;
        castle = newCastle;
        enemyCastle = newEnemyCastle;
        twin = unit.getActionTwin();
    ...
    private void interpretAction(short action, short actor, short target) {
        try {
            ...
            Log.error("ScriptDoppelganger.interpretAction " + e);
        }
    }
}
