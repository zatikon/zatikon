...
public class AnimationSpin implements Animation {
    /////////////////////////////////////////////////////////////////
    // Constants
    /////////////////////////////////////////////////////////////////
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public AnimationSpin(short newSource, short newLocation, short newDamage, int newImage, Unit newVictim, int newDelay) {
        source = newSource;
        ...
        stepX = x2 - x1;
        stepY = y2 - y1;
        stepX *= (Constants.STEP_SPEED);
        stepY *= (Constants.STEP_SPEED);
        stepX /= distance;
        stepY /= distance;
    ...
    public void draw(Graphics2D g, Frame frame, LeoComponent surface) {
        ...
        if (finished()) {
            ...
            Client.getGameData().add(new AnimationDamage(source, location, damage, victim, Constants.SOUND_INORG_DEATH));
        }
    }
