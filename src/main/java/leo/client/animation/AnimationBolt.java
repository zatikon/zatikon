///////////////////////////////////////////////////////////////////////
// Name: AnimationBolt
// Desc: Green bolt from the channeler
...
public class AnimationBolt implements Animation {
    /////////////////////////////////////////////////////////////////
    // Properties
    /////////////////////////////////////////////////////////////////
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public AnimationBolt(short newSource, short newLocation, short newDamage, Unit newVictim) {
        source = newSource;
    ...
    public void draw(Graphics2D g, Frame frame, LeoComponent surface) {
        ...
        if (finished()) {
            ...
            Client.getGameData().add(new AnimationBurst(location, 3, Constants.IMG_GREEN_BALL));
