...
public class AnimationWheel implements Animation {
    /////////////////////////////////////////////////////////////////
    // Constants
    /////////////////////////////////////////////////////////////////
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public AnimationWheel(short newLocation, boolean noisy) {
    ...
    public void draw(Graphics2D g, Frame frame, LeoComponent surface) {
        ...
        g.drawImage(Client.getImages().getImage(Constants.IMG_WHEEL), transform, frame);
        ...
        // draw image 2
        g.drawImage(Client.getImages().getImage(Constants.IMG_FACE), transform, frame);
