...
public class AnimationTarget implements Animation {
    /////////////////////////////////////////////////////////////////
    // Constants
    /////////////////////////////////////////////////////////////////
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public AnimationTarget(short newLocation, boolean noisy) {
    ...
    public void draw(Graphics2D g, Frame frame, LeoComponent surface) {
        ...
        // Draw target
        int anim = Constants.IMG_TARGET_02 + (30 - duration);
        if (anim >= Constants.IMG_TARGET_12) anim = Constants.IMG_TARGET_12;
        ...
        g.drawImage(Client.getImages().getImage(Constants.IMG_TARGET_01), transform, frame);
