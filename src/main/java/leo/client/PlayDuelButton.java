///////////////////////////////////////////////////////////////////////
// Name: PlayButton
// Desc: Play the game with a random army
...
public class PlayDuelButton extends LeoComponent {
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public PlayDuelButton(LeoContainer parent, int x, int y, int width, int height) {
        super(x, y, width, height);
        rosterText = new RosterText(parent,
                "Enter a queue to play another player in a one-on-one match using randomly generated armies.",
                4, 455, 186, 142);
    }
    ...
    public void draw(Graphics2D g, Frame mainFrame) {
        ...
        drawText(g, "Random", getScreenX() + getWidth() + 4, getScreenY() + getHeight() - 12);
    }
