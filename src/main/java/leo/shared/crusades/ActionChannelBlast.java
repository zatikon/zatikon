///////////////////////////////////////////////////////////////////////
//	Name:	ActionChannelBlast
//	Desc:	Blast it with energy
...
public class ActionChannelBlast implements Action {

    /////////////////////////////////////////////////////////////////
    // Properties
    /////////////////////////////////////////////////////////////////
    private final UnitChanneler owner;
    private final String detail = Strings.ACTION_CHANNEL_BLAST_1;


    /////////////////////////////////////////////////////////////////
    // Constructor
    /////////////////////////////////////////////////////////////////
    public ActionChannelBlast(Unit newOwner) {
    ...
    public String perform(short target) {
        ...
        // The costs
        short energy = (byte) owner.getEnergy();
        ...
        if (outcome == Event.OK) {
            damage = victim.damage(owner, energy);
        }

        owner.getCastle().getObserver().attack(owner, victim, damage, Action.ATTACK_CHANNEL_BLAST);

        // stop here if it's done
        if (outcome == Event.CANCEL) {
            return owner.getName() + Strings.ACTION_CHANNEL_BLAST_2 + getName();
        }
        ...
        // all done
        return "" + owner.getName() + Strings.ACTION_CHANNEL_BLAST_3 + victim.getName();
    }
    ...
    public String getDescription() {
        return Strings.ACTION_CHANNEL_BLAST_4;
    }
    ...
    public String getRangeDescription() {
        return Strings.ACTION_CHANNEL_BLAST_5 + getRange();
    }
    ...
    public String getCostDescription() {
        return Strings.ACTION_CHANNEL_BLAST_6;
    }
    ...
    public String getName() {
        return Strings.ACTION_CHANNEL_BLAST_7;
    }
