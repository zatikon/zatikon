...
public class EventStratagem implements Event, Action {
    ...
    private final String detail = Strings.EVENT_STRATAGEM_1;
    short extras = 0;
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public EventStratagem(Unit newOwner) {
        owner = newOwner;
    }
    ...
    public short perform(Unit source, Unit target, short val1, short val2, short recursive) {
        ...
        if (owner.getCastle() == source.getCastle()) return Event.OK;
    ...
    public String getDescription() {
        return Strings.EVENT_STRATAGEM_2;
    }

    public String getRangeDescription() {
        return Strings.EVENT_STRATAGEM_3;
    }

    public String getCostDescription() {
        return Strings.EVENT_STRATAGEM_4 + extras;
    }
    ...
    public String getName() {
        return Strings.EVENT_STRATAGEM_5;
    }
