...
public class ActionLife implements Action {
    ...
    private final String detail = Strings.ACTION_LIFE_1;
    ...
    public String perform(short target) {
        ...
        return "" + owner.getName() + Strings.ACTION_LIFE_2 + victim.getName();
