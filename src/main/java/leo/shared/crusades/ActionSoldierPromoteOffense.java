...
public class ActionSoldierPromoteOffense implements Action {
    ...
    private final String detail = Strings.ACTION_PROMOTE_OFFENSE_1;


    /////////////////////////////////////////////////////////////////
    // Constructor
    /////////////////////////////////////////////////////////////////
    public ActionSoldierPromoteOffense(Unit newOwner) {
        owner = newOwner;
    ...
    public String perform(short target) {
        ...
        trainee.recieveTraining(UnitSoldier.OFFENSE);
        ...
        return "" + owner.getName() + " promotes " + trainee.getName() + " to Offense.";
    }
    ...
    public Vector<Short> getTargets() {
        Vector<Short> targets = owner.getBattleField().getTargets(owner, targetType, range, false, true, false, TargetType.FRIENDLY, owner.getCastle());
        ...
        while (targs.hasNext()) {
            ...
            if (!(victim instanceof UnitSoldier) || ((UnitSoldier) victim).training == UnitSoldier.OFFENSE)
                removers.add(targ);
        }
    ...
    public String getDescription() {
        return Strings.ACTION_PROMOTE_OFFENSE_2;
    }
    ...
    public String getName() {
        return Strings.ACTION_PROMOTE_OFFENSE_4;
    }
