...
public class EventVigilant implements Event, Action {
    ...
    private final String detail = Strings.EVENT_VIGILANT_1;


    /////////////////////////////////////////////////////////////////
    // Constructor
    /////////////////////////////////////////////////////////////////
    public EventVigilant(Unit newOwner) {
        owner = newOwner;
    }
    ...
    public short perform(Unit source, Unit target, short val1, short val2, short recursive) {
        ...
        // attack!
        if (BattleField.inRange(owner.getAttack(), to) && owner.getAttack().validate(to)) {
    ...
    public String getDescription() {
        return Strings.EVENT_VIGILANT_2;
    }
    ...
    public String getCostDescription() {
        return Strings.EVENT_VIGILANT_3;
    }
    ...
    public String getName() {
        return Strings.EVENT_VIGILANT_4;
    }
