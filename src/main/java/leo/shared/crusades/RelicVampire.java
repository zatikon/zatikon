...
public class RelicVampire extends Unit {
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public RelicVampire(Castle newCastle) {
        castle = newCastle;
        ...
        // Initialize
        id = UnitType.RELIC_VAMPIRE.value();
        ...
        isRelic = true;
        organic = false;
        appearance = Constants.IMG_RELIC_VAMPIRE;
        ...
        ActionTrait relicEffect = new ActionTrait(this, Strings.RELIC_VAMPIRE_2, Strings.RELIC_VAMPIRE_3, Strings.RELIC_VAMPIRE_4);
        relicEffect.setType(Action.SKILL);
        relicEffect.setDetail(Strings.RELIC_VAMPIRE_5);
        add(relicEffect);
    }
    ...
    public void preDeploy(short target) {
        ...
        ally.grow(Action.GROW_RELIC_VAMPIRE);
    }
