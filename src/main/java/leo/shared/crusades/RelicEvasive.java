///////////////////////////////////////////////////////////////////////
// Name: RelicEvasive
// Desc: A Relic (one use per battle) that makes the target unit evasive
...
public class RelicEvasive extends Unit {
    ...
    // Constructor
    /////////////////////////////////////////////////////////////////
    public RelicEvasive(Castle newCastle) {
        castle = newCastle;
        ...
        // Initialize
        id = UnitType.RELIC_EVASIVE.value();
        ...
        isRelic = true;
        organic = false;
        appearance = Constants.IMG_RELIC_EVASIVE;
        ...
        ActionTrait relicEffect = new ActionTrait(this, Strings.RELIC_EVASIVE_2, Strings.RELIC_EVASIVE_3, Strings.RELIC_EVASIVE_4);
        relicEffect.setType(Action.SKILL);
        relicEffect.setDetail(Strings.RELIC_EVASIVE_5);
        add(relicEffect);
    }
    ...
    public void preDeploy(short target) {
        ...
        ally.grow(Action.GROW_RELIC_EVASION);
    }
