...
public class EventBlock implements Event, Action {
    ...
    private final String detail = Strings.EVENT_BARRAGE_BLOCK_1;

    /////////////////////////////////////////////////////////////////
    // Constructor
    /////////////////////////////////////////////////////////////////
    public EventBlock(Unit newOwner) {
        owner = newOwner;
    }
    ...
    public short perform(Unit source, Unit target, short val1, short val2, short recursive) {
        ...
        if (BattleField.getDistance(source.getLocation(), victim.getLocation()) <= 1) return Event.OK;
    ...
    public String getDescription() {
        return Strings.EVENT_BARRAGE_BLOCK_2;
    }
    ...
    public String getCostDescription() {
        return Strings.EVENT_BARRAGE_BLOCK_3;
    }
    ...
    public String getName() {
        return Strings.EVENT_BARRAGE_BLOCK_4;
    }
