...
public class EventSlay implements Event, Action {
    ...
    private final String detail = Strings.EVENT_SLAY_1;


    /////////////////////////////////////////////////////////////////
    // Constructor
    /////////////////////////////////////////////////////////////////
    public EventSlay(Unit newOwner) {
        owner = newOwner;
    }
    ...
    public short perform(Unit source, Unit target, short val1, short val2, short recursive) {
        ...
        if (victim.getArmor() > 0) return Event.OK;
